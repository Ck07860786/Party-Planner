  ...
  return (
    <div className="relative w-full h-screen">
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-center px-4">
        ...
        <h1 className='text-white text-center py-4 text-4xl md:text-6xl font-Lato'>
          Expert Event <span className='text-purple-300'>Services at</span>💫
        </h1>
        <h1 className='text-white text-center text-4xl md:text-6xl font-Lato'>
          Your Fingertips!
        </h1>
        <p className='text-center text-purple-100 font-Lato mt-6 text-lg leading-8'>
          Elevate your event with our premier services, meticulously crafted to delight and impress. Let our
        </p>
        <p className='text-center text-purple-100 font-Lato text-lg leading-8'>
          stellar reviews guide you towards an experience that exceeds all expectations.
        </p>
