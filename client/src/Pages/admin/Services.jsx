          ...
          <div className="bg-black flex-grow">
            <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-10 lg:max-w-7xl lg:px-8">
              <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
                {services?.map((s) => (
                  <div key={s._id} className="flex flex-col rounded-lg border shadow-md shadow-purple-500 border-purple-500 p-3 mb-6">
                    <Link to={`/dashboard/admin/services/${s.slug}`}>
                      <div className="group relative">
                        ...
                        <div className="mt-4 flex justify-between">
                          <div>
                            ...
                            <h3 className="font-Lato text-purple-400 font-bold text-xl">{s.name}</h3>
                          </div>
                        </div>
                        <div>
